...
USER_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzQ0NzM3OTY3LCJpYXQiOjE3NDQ3MzQzNjcsImp0aSI6ImRmOTUxOTA2OTZkZjQxY2NhYjYyNzRkMjhmMGVlMDc3IiwidXNlcl9pZCI6IjZlOTE5YmNiLTc0ZjUtNDFlZi05OTRkLWEzZDY2NDQ5YjFhOSJ9.qJEArp4zpueBEsDr9N7VqwC_WkoUYdf1Kezy3NmYJ4Y"  # Replace with a real DRIVER token
TRIP_STATUS = "arrived at pickup"  # Simulate this status update

# === WebSocket Event Handlers ===

def on_open(ws):
    print("[INFO] WebSocket connection opened. Sending trip status update...")
